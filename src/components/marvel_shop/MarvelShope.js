...
export class MarvelShop extends MarvelComponent{
    ...
    render() {
        ...
        <table>
            ...
            <tr>
                <td>
                    <img class="shop_table_img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQohu73PI3w-oxlnNHoG_Ba5kqX-gcvEe32tQ&usqp=CAU" alt="Logo hero" title="Logo hero">
                </td>
                <td>
                    Name
                </td>
                ...
                <td class="table_call">
                    <button class="btn btn-danger">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-minus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
